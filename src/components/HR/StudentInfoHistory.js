...
import "../br.css" 
import StudentHeader from '../HR/StudentHeader';

 

const StudentInfoHistory = () => {
...
{ shouldshow && (
     ...
     <StudentHeader />
        ...
        <EditProfileRoot> Student Information</EditProfileRoot>
        </div>
...
export default StudentInfoHistory; 
